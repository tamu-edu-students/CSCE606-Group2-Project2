...
# Deployment is handled outside this repository (e.g., CI to Heroku)
...
group :development, :test do
  ...
  # Use SQLite for local development and tests (faster to get started)
  # ActiveRecord 8 requires sqlite3 >= 2.1; allow modern sqlite3 releases
  gem "sqlite3", ">= 2.1"
